  ...
  return (
    <>
      <div className="home-container1">
        <Head>
          <title>Jivayu Homoeopathic Clinic | Nagpur</title>
          <meta
            name="description"
            content="Expert Homeopathic Treatments For Total Family Health in Nagpur. Consult Dr. Priyanka Vishwakarma For Safe, Holistic, And Personalized Care. Book Now."
          />
          <meta
            property="og:title"
            content="Jivayu Homoeopathic Clinic | Nagpur"
          />
          <meta
