  ...
  return (
    <>
      <div className="about-us-container1">
        <Head>
          <title>
            About Dr. Priyanka Vishwakarma | Jivayu Homeopathy Nagpur
          </title>
          <meta
            name="description"
        ...
        ></FooterMobile>
        <a href="https://play.teleporthq.io/signup" className="about-us-link">
          <div
            aria-label="Sign up to TeleportHQ"
            className="about-us-container2"
          >
            <svg
              width="24"
              height="24"
            ...
            <span className="about-us-text98">Built in TeleportHQ</span>
          </div>
        </a>
      </div>
      <style jsx>
